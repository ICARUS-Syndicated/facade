package rwp.annieawa.recipeaddon.command;
...
public class RecipeCommand implements CommandExecutor, TabCompleter {
    ...
    public RecipeCommand(RecipeAddon plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        if (args.length == 0) {
            sender.sendMessage("§c用法: /recipeaddon reload | /recipeaddon get result <key> [数量] | /recipeaddon get ingredient <key> [序号] | /recipeaddon get recipes <玩家> <模式>");
            return true;
        }

        if (args[0].equalsIgnoreCase("reload")) {
            if (!sender.hasPermission("recipeaddon.admin")) {
            ...
            if (args.length < 2) {
                sender.sendMessage("§c用法: /recipeaddon get result <key> [数量] | /recipeaddon get ingredient <key> [序号] | /recipeaddon get recipes <玩家> <模式>");
                return true;
            }
    ...
    private boolean handleGetRecipes(CommandSender sender, String[] args) {
        ...
        if (args.length < 4) {
            sender.sendMessage("§c用法: /recipeaddon get recipes <玩家> <模式>");
    ...
    private boolean handleGetResult(CommandSender sender, String[] args) {
        ...
        if (args.length < 3) {
            sender.sendMessage("§c用法: /recipeaddon get result <key> [数量]");
            return true;
        }
    ...
    private boolean handleGetIngredient(CommandSender sender, String[] args) {
        ...
        if (args.length < 3) {
            sender.sendMessage("§c用法: /recipeaddon get ingredient <key> [序号]");
            return true;
        }
